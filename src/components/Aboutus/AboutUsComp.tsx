...
const AboutUsComp=()=> {
  return (
    ...
    <div className="about-us-comp-body">
      <div className="about-us-comp-aboutLogo">
        <img src={aboutLogo} />
      </div>
      ...
      <div>
        <h1 className="about-us-comp-title">ABOUT US:</h1>
        <p className="about-us-comp-parograph">
          ...
          porta.
          Vivamus elit urna, dignissim a vestibulum. Lorem ipsum dolor
